"""Launch the one frozen 120-clip/2880-frame complete-event UE capture.
...
def verify_protocol(protocol, spec, repo):
    ...
    mandatory = {'spatial_bce_capture.py', 'launch_spatial_bce.py', 'ue_capture_readiness.py', 'spatial_bce_spec.py', 'core_transfer_spec.py'}
...
def main():
    ...
    capture_script = Path(__file__).with_name('spatial_bce_capture.py').resolve()
