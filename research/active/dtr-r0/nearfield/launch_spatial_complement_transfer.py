"""Launch the one frozen 48-clip/1152-frame complete-event UE capture.
...
def verify_protocol(protocol, spec, repo):
    ...
    mandatory = {'spatial_complement_transfer_capture.py', 'launch_spatial_complement_transfer.py', 'ue_capture_readiness.py', 'spatial_complement_transfer_spec.py', 'core_transfer_spec.py', 'launch_spatial_bce.py', 'spatial_bce_spec.py'}
...
def main():
    ...
    capture_script = Path(__file__).with_name('spatial_complement_transfer_capture.py').resolve()
