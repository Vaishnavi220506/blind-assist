"""Launch the one frozen 24-clip/576-frame complete-event UE capture.
...
def verify_protocol(protocol, spec, repo):
    ...
    mandatory = {'full_event_capture_20260920.py', 'launch_full_event_20260920.py', 'ue_capture_readiness.py'}
...
def main():
    ...
    capture_script = Path(__file__).with_name('full_event_capture_20260920.py').resolve()
