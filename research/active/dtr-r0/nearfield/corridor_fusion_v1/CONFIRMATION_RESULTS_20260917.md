...
The first attempt remains failed. Identical-source acquisition subsequently
completed; the [complete scientific result](CONFIRMATION_FINAL_20260917.md)
supersedes the outstanding-confirmation status below.
